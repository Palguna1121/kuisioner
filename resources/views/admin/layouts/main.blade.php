...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard" class="brand-link">
      ...
      <span class="brand-text font-weight-light mx">Kuisioner</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">Grafik Kuisioner</li>
          <li class="nav-item">
            <a href="/admin/graph" class="nav-link">
          ...
          <li class="nav-header">Kelola Kuisioner</li>
          <li class="nav-item">
...
<script>
  document.getElementById('logout').addEventListener('click', function(event) {
      event.preventDefault(); // Menghentikan tautan dari melakukan navigasi
